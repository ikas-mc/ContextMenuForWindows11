...
const  wchar_t* CustomeExplorerCommand::Title() { 

	winrt::hstring DisplayName = winrt::unbox_value_or<winrt::hstring>(winrt::Windows::Storage::ApplicationData::Current().LocalSettings().Values().Lookup(L"Custome_Menu_Name"), L"Custome Menu");
...
CustomeExplorerCommand::CustomeExplorerCommand() {
...
void CustomeCommands::ReadCommands()
{
	...
	//winrt::hstring DisplayName = winrt::unbox_value_or<winrt::hstring>(winrt::Windows::Storage::ApplicationData::Current().LocalSettings().Values().Lookup(L""), DefaultDisplayName);
